"""
Django settings for Golden_Wave project.
...
SECRET_KEY = 'django-insecure-2g@ffsyg%1=nvqa8==+o69p40vf@dqr5=l_ivz(%h98d#(q_@!'
...
WSGI_APPLICATION = 'Golden_Wave.wsgi.application'
